...
plyr.each(function(i){
    ...
    players.on('timeupdate',function(){
       ...
       if(times>=duration){
        ...
        playerPop.append('<div class= "pop-up">  <div class= "ok-button" ></div><div class="clear"></div><div class="ani"></div> <p class=tekst-pop-up> Je hebt deze video af en bent er wijzer van geworden</p> </div>')
